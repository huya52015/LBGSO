  ...
  const handleLoadPreset = (presetName: string) => {
    if (presetName === "tanbinh" || presetName === "tanthanh") {
      onApplyTimetable({
        ...
        schoolName: "Trường Tiểu học Tân Bình",
        effectiveDate: "Áp dụng từ Tuần 1 (07/09/2026 - 11/09/2026)",
      });
      setParseStatus("Đã tải thành công TKB chuẩn: Trường Tiểu học Tân Bình (Tuần 1 từ 07/09/2026)");
      setIsSuccess(true);
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                ...
                >
                  <div className="font-bold text-xs text-black group-hover:underline">
                    Trường TH Tân Bình (07/09/2026)
                  </div>
                  <div className="text-[11px] text-stone-600 mt-1 font-serif">
                    Thời khóa biểu mới áp dụng Tuần 1 từ 7/9/2026 (Lần 2), phân công 15 GV.
                  </div>
                </button>
