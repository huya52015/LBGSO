  ...
  const handleDownloadTeacherTKB = async (t: TeacherInfo) => {
    ...
    try {
      if (t.type === "specialist") {
        ...
        const cls = t.assignedClasses?.[0] || "1A1";
    ...
    <div className="space-y-6">
      ...
      <div className="bg-stone-50 border-2 border-black p-5 sm:p-6 shadow-[4px_4px_0px_rgba(0,0,0,1)]">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 border-b-2 border-black pb-5">
          <div className="space-y-1">
            <div className="flex items-center gap-2 flex-wrap">
              <span className="text-[10px] font-mono font-bold uppercase bg-black text-white px-2 py-0.5 tracking-wider">
                Trung Tâm Đồng Bộ Toàn Trường
              </span>
              <span className="text-[10px] font-mono font-bold bg-amber-200 text-amber-950 px-2 py-0.5 border border-amber-400">
                {DEFAULT_TEACHERS.length} Giáo Viên • 100% Khớp TKB Tuần {schoolInfo.week}
              </span>
            </div>
            <h2 className="text-xl sm:text-2xl font-serif font-black tracking-tight uppercase text-black">
              Đồng Bộ Thời Khóa Biểu • Lịch Báo Giảng • Kế Hoạch Bài Dạy
            </h2>
            <p className="text-xs text-stone-700 font-serif leading-relaxed">
              {schoolInfo.schoolName} {schoolInfo.branchName ? `— ${schoolInfo.branchName}` : ""} • Năm học {schoolInfo.academicYear} • Áp dụng tuần {schoolInfo.week} ({schoolInfo.startDate} - {schoolInfo.endDate})
            </p>
          </div>
          ...
          <div className="flex items-center flex-wrap gap-2">
            <button
              ...
              title="Tải bảng TKB A4 Toàn trường (khổ ngang)"
            >
              <Calendar className="w-3.5 h-3.5" />
              <span>Tải TKB Toàn Trường (.docx)</span>
            </button>
            ...
            >
              ...
              <span>Tải Trọn Bộ GV Hiện Tại ({schoolInfo.teacherName.split(" ").pop()})</span>
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-4">
          <div className="bg-white border border-black p-3 shadow-[2px_2px_0px_rgba(0,0,0,1)] flex items-center gap-3">
            ...
            <div>
              <div className="text-lg font-mono font-black text-black">{DEFAULT_TEACHERS.length} Giáo Viên</div>
              <div className="text-[11px] text-stone-600">{homeroomList.length} GV Chủ Nhiệm + {specialistList.length} GV Bộ Môn</div>
            </div>
          </div>
          ...
          <div className="bg-white border border-black p-3 shadow-[2px_2px_0px_rgba(0,0,0,1)] flex items-center gap-3">
            ...
            <div>
              <div className="text-lg font-mono font-black text-black">10 Lớp Học</div>
          ...
          <div className="bg-white border border-black p-3 shadow-[2px_2px_0px_rgba(0,0,0,1)] flex items-center gap-3">
            ...
            <div>
              <div className="text-lg font-mono font-black text-emerald-900">320 Tiết / Tuần</div>
              <div className="text-[11px] text-stone-600">Đồng bộ TKB • LBG • KHBD 100%</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-4 border border-black shadow-[2px_2px_0px_rgba(0,0,0,1)] flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
        ...
        <div className="flex items-center border border-black overflow-hidden bg-white shadow-[1px_1px_0px_rgba(0,0,0,1)]">
          ...
          >
            Tất Cả 18 Giáo Viên ({DEFAULT_TEACHERS.length})
          </button>
          <button
            type="button"
          ...
          >
            10 GV Chủ Nhiệm ({homeroomList.length})
          </button>
          <button
            type="button"
          ...
          >
            8 GV Bộ Môn & Chuyên ({specialistList.length})
          </button>
        </div>
        ...
        <div className="w-full md:w-64">
          <input
            ...
            placeholder="Tìm theo tên GV, lớp, môn..."
      ...
      <div className="bg-white border-2 border-black shadow-[4px_4px_0px_rgba(0,0,0,1)] overflow-hidden">
        <div className="p-3 bg-stone-100 border-b border-black flex items-center justify-between">
          <h3 className="text-xs font-bold uppercase tracking-wider text-black font-mono flex items-center gap-2">
            ...
            BẢNG CHI TIẾT ĐỒNG BỘ 18 GIÁO VIÊN — PHÂN HIỆU TÂN BÌNH
          </h3>
          <span className="text-[11px] font-serif italic text-stone-600">
            Giáo viên đang chọn: <strong className="text-black not-italic font-bold">{schoolInfo.teacherName}</strong>
          </span>
        </div>
          ...
          <table className="w-full text-left border-collapse text-xs">
            <thead>
              <tr className="bg-stone-50 border-b border-black text-stone-900 font-serif font-bold uppercase text-[10px] tracking-wider">
                <th className="py-2.5 px-3 border-r border-black w-12 text-center">STT</th>
                <th className="py-2.5 px-3 border-r border-black min-w-[150px]">Họ và Tên Giáo Viên</th>
                <th className="py-2.5 px-2 border-r border-black w-24 text-center">Chức Vụ</th>
                <th className="py-2.5 px-2 border-r border-black w-24 text-center">Lớp Phụ Trách</th>
                <th className="py-2.5 px-2 border-r border-black w-20 text-center">Thực Dạy</th>
                <th className="py-2.5 px-2 border-r border-black w-20 text-center">Kiêm Nhiệm</th>
                <th className="py-2.5 px-2 border-r border-black w-20 text-center">Tổng Tiết</th>
                <th className="py-2.5 px-3 border-r border-black min-w-[160px] text-center">Trạng Thái Đồng Bộ</th>
                <th className="py-2.5 px-3 text-center min-w-[240px]">Thao Tác Tải & Làm Việc</th>
              </tr>
            </thead>
                ...
                return (
                  ...
                  >
                    ...
                    <td className="py-2.5 px-2 border-r border-black text-center font-mono text-stone-600">
                      {concurrentP > 0 ? `${concurrentP} tiết` : "—"}
                    </td>
                    ...
                    <td className="py-2.5 px-3 border-r border-black">
                      <div className="flex items-center justify-center gap-1.5 flex-wrap">
                        ...
                        <span className="text-[9px] font-mono font-bold bg-purple-100 text-purple-900 px-1.5 py-0.5 border border-purple-300 flex items-center gap-0.5">
                          <Check className="w-2.5 h-2.5" /> KHBD: {teachingP} bài
                        </span>
                      </div>
                    </td>
                    ...
                    <td className="py-2.5 px-3 text-center">
                      <div className="flex items-center justify-center gap-1.5 flex-wrap">
                        ...
                        <button
                          ...
                          title="Chọn giáo viên này để làm việc trên toàn hệ thống"
                        >
                          {isCurrent ? <Check className="w-3 h-3" /> : <ChevronRight className="w-3 h-3" />}
                          <span>{isCurrent ? "Đang chọn" : "Chọn GV"}</span>
                        </button>
                        ...
                        <button
                          ...
                          title={`Tải Thời khóa biểu Word cho ${teacher.name}`}
                        >
                        ...
                        <button
                          ...
                          className="px-2 py-1 bg-stone-100 hover:bg-stone-200 text-stone-900 text-[10px] font-bold uppercase tracking-wider border border-stone-400 transition-colors cursor-pointer disabled:opacity-50"
                          title={`Tải Lịch báo giảng Word cho ${teacher.name}`}
                        >
                        ...
                        <button
                          ...
                          title={`Tải Kế hoạch bài dạy (kèm LBG) cho ${teacher.name}`}
                        >
                        ...
                        <button
                          ...
                          title="Mở giao diện soạn giáo án KHBD của GV này"
                        >
      ...
      <div className="bg-[#f7f6f2] border border-black p-4 sm:p-5 shadow-[2px_2px_0px_rgba(0,0,0,1)]">
        <h4 className="text-xs font-bold uppercase tracking-wider text-black font-serif flex items-center gap-2 mb-2">
          ...
          Quy Chuẩn Đồng Bộ Tự Động Theo Thời Khóa Biểu Tuần 1 (07/09/2026 - 11/09/2026)
        </h4>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs text-stone-700 leading-relaxed font-serif">
          <div className="bg-white p-3 border border-stone-300">
            <strong className="text-black">1. Đối với 10 Giáo Viên Chủ Nhiệm (Khối 1 - 5):</strong>
            <ul className="list-disc list-inside mt-1 space-y-0.5 text-[11px] text-stone-600">
              <li>TKB lớp chủ nhiệm gồm đủ 32 tiết (có ghi chú rõ giáo viên chuyên dạy tiết nào).</li>
              <li>LBG & KHBD cá nhân tự động tách biệt: Chỉ gồm các tiết do chính GVCN trực tiếp giảng dạy (16-19 tiết).</li>
              <li>Đã tự động loại trừ các môn chuyên (Tiếng Anh, Tin học, Âm nhạc, Mĩ thuật, GDTC...).</li>
            </ul>
          </div>

          <div className="bg-white p-3 border border-stone-300">
            <strong className="text-black">2. Đối với 8 Giáo Viên Bộ Môn & Chuyên:</strong>
            <ul className="list-disc list-inside mt-1 space-y-0.5 text-[11px] text-stone-600">
              <li>TKB cá nhân tự động tổng hợp tất cả các lớp phụ trách giảng dạy từ Thứ 2 đến Thứ 6.</li>
              <li>LBG và KHBD lập theo đúng phân phối chương trình của môn chuyên tương ứng.</li>
              <li>Xuất file Word A4 chuẩn thể thức công văn 2345/BGDĐT-GDTH.</li>
            </ul>
          </div>
        </div>
      </div>
